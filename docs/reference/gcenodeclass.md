...
| `linuxNodeConfig` _[LinuxNodeConfig](#linuxnodeconfig)_ | LinuxNodeConfig configures the Linux kernel of provisioned nodes.<br />Mirrors GKE node pool NodeConfig.linuxNodeConfig. |  | Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `hugepages` _[HugepagesConfig](#hugepagesconfig)_ | Hugepages configures the static hugepages that the node allocates at boot.<br />Mirrors GKE node pool LinuxNodeConfig.hugepages. |  | Optional: \{\} <br /> |
